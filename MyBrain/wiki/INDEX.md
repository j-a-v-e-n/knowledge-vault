...
**最后更新**：2026-05-01 | **页面总数**：63 | **最新操作**：编译 COGS117 Week 5 语言习得 4 个新材料 — 经典 [[Saffran_1996_统计学习]]（Science 1996，8月婴儿仅 2 分钟统计学习）+ 现代 [[Vong_2024_单童语言习得]]（Science 2024，单孩 SAYcam + CVCL 对比学习）+ Lecture 8/9（[[Zettersten_2026_Lecture8_语言1与如何读论文|L8 论文阅读技能]] + [[Zettersten_2026_Lecture9_语言2|L9 词语学习机制]]）；新建 2 concept（[[统计学习]]、[[词语学习机制]]）+ 1 debate（[[争论_先天语言vs统计学习]]）；渲染 33 张图（attachments/COGS117/）；多个跨课程链接（CVCL ↔ ECE175B [[统一多模态生成架构]]、Saffran ↔ [[ECE175B_Lecture1b_贝叶斯网络]] bigram）
...
| **concept** | [[监督学习与无监督学习]], [[自监督学习与基础模型]], [[感知窄化]], [[面孔知觉发展]], [[核心知识理论]], [[物体识别与形状感知]], [[发展研究方法]], [[统一多模态生成架构]], [[动作发展]], [[发展级联]], [[内在动机与好奇心驱动学习]], [[统计学习]], [[词语学习机制]] |
...
**前次增长（2026-04-27）**：+2 source（[[Arakawa_2023_LemurDx]] + [[Garg_2025_DopFone]]）；**lint 待办**：`notes/ECE284/Bhamla_2017_Paperfuge.md` 内容错位仍未修复（待 Javen 拍板）；`wiki/医疗技术/` 子目录提议仍 pending
