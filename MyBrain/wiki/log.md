...
| 文件 | 类型 | 位置 | 用途 |
|---|---|---|---|
| `automation/docs/lessons.md` | 元方法论（system 类） | `MyBrain/system/` | debug 方法论 6 条 + 5 项 checklist。"同一假设修 3 次失败 → 强制重审 root cause"是核心 |
...
- "遇到 debug 卡死 → 翻 `automation/docs/lessons.md`"
...
详见 `MyBrain/automation/runs/2026-04-27.md`。
