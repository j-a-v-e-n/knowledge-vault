...
def main():
    ...
    add_multi_line(
        ...
        [
            ...
            ("    % of Med-HALT questions GPT-3.5", 16, False, GREY, True),
            ("    answers correctly:", 16, False, GREY, True),
            ("      • 0 examples in prompt → 7.31%", 17, False, GREY, True),
            ("      • 5 examples in prompt → ~25%", 17, False, GREY, True),
            ("      • Random guess (4 choices) = 25%", 17, False, GREY, True),
            ("    → Examples teach format, not knowledge.", 16, False, GREY, True),
        ],
        left=0.5,
        top=1.4,
        width=6.2,
    ...
    add_multi_line(
        ...
        [
            ...
            ("    Paper tests Text-Davinci, GPT-3.5,", 18, False, GREY, True),
            ("    Llama-2, Falcon, MPT.", 18, False, GREY, True),
            ("    GPT-4 / Claude / Med-PaLM 2 — unknown.", 18, False, GREY, True),
            ("", 16, False, BLACK, False),
            ("6. Use scoring to TRAIN, not just SCORE?", 22, True, BLACK, False),
            ("    Paper uses +1 / −0.25 to grade models.", 18, False, GREY, True),
            ("    What if we used the same formula as", 18, False, GREY, True),
            ("    RLHF reward — train honest LLMs?", 18, False, GREY, True),
        ],
        left=7.0,
        top=1.4,
        width=6.2,
