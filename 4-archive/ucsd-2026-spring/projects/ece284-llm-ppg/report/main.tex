...
% Allow LaTeX small per-paragraph stretching to avoid 2-column overfull \hbox.
% emergencystretch only kicks in when normal hyphenation/justification can't fit.
